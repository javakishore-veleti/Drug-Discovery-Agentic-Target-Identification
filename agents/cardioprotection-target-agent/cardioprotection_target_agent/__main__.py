"""CLI: python -m cardioprotection_target_agent \"question\"."""
...
from cardioprotection_target_agent.prompts import SYSTEM_PROMPT


def main() -> int:
    return main_for_agent(
        agent_title="Cardioprotection Target Agent",
