...
story_key: "1.2"
epic: "Epic 1"
title: "Research-assist system prompt"
baseline_commit: "352675b"
completion_commit: "352675b"
...
System prompt enforces research-only / not medical advice boundary.

## Acceptance Criteria

See `_bmad-output/planning-artifacts/epics.md` (and `epics-local-specialists.md` for L.*) story **1.2**.
...
| Date | Commit | Note |
| --- | --- | --- |
| 2026-07-25/26 | `352675b` | Story 1.2 completion on `main` |
