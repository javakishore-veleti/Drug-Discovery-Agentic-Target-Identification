...
story_key: "L.1"
epic: "Epic L"
title: "Shared framework contract"
...
agents/framework shared config, research-assist boundary, V1 tool wiring, CLI helpers.

## Acceptance Criteria

See `_bmad-output/planning-artifacts/epics.md` (and `epics-local-specialists.md` for L.*) story **L.1**.
...
| Date | Commit | Note |
| --- | --- | --- |
| 2026-07-25/26 | `c379ecd` | Story L.1 completion on `main` |
