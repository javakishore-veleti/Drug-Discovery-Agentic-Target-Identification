...
story_key: "L.5"
epic: "Epic L"
title: "Cardioprotection target agent (local)"
...
Local cardiac-safety specialist scaffold.

## Acceptance Criteria

See `_bmad-output/planning-artifacts/epics.md` (and `epics-local-specialists.md` for L.*) story **L.5**.
...
- `agents/cardioprotection-target-agent/`

### Change Log

| Date | Commit | Note |
| --- | --- | --- |
| 2026-07-25/26 | `c379ecd` | Story L.5 completion on `main` |
