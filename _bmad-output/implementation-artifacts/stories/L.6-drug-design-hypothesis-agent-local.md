...
story_key: "L.6"
epic: "Epic L"
title: "Drug design hypothesis agent (local)"
...
Local design-hypothesis specialist scaffold.

## Acceptance Criteria

See `_bmad-output/planning-artifacts/epics.md` (and `epics-local-specialists.md` for L.*) story **L.6**.
...
- `agents/drug-design-hypothesis-agent/`

### Change Log

| Date | Commit | Note |
| --- | --- | --- |
| 2026-07-25/26 | `c379ecd` | Story L.6 completion on `main` |
